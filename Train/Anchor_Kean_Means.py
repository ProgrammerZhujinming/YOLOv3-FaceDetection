...
target_size = 608
k = 9
gtbox_path = "../DataSet/WiderFace/WIDER_train/wider_face_train_bbx_gt.txt"
imgs_path = "../DataSet/WiderFace/WIDER_train/images"

img_path = ""
gtbox_num = 0
coords = []
train_data = []  # [img_path,[[coord, class_id]]]
    ...
    for gtbox_data in gtbox_file:
        if gtbox_data.find(".jpg") != -1:
            if img_path != "" and len(coords) != 0:
                ...
                train_data.append([img_path, coords])
                coords = []
            img_path = gtbox_data
