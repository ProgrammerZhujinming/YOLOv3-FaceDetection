...
weight_decay = 5e-4
momentum = 0.9
pre_weight_file = "../PreTrain/weights/Darknet-53_final.pth"
class_num = 1
...
#---------------step1:Dataset-------------------
import torch
from Train.WiderFace_DataSet import widerface_detection
train_dataSet = widerface_detection(imgs_path="../DataSet/WiderFace/WIDER_train/images",gtbox_path="../DataSet/WiderFace/WIDER_train/wider_face_train_bbx_gt.txt", is_train=True, class_num=class_num)
val_dataSet = widerface_detection(imgs_path="../DataSet/WiderFace/WIDER_val/images",gtbox_path="../DataSet/WiderFace/WIDER_val/wider_face_val_bbx_gt.txt", is_train=False, class_num=class_num)
    ...
    while epoch <= epoch_num:
        ...
        with tqdm(total=train_len) as tbar:
            for batch_index, batch_datas in enumerate(train_loader):
                ...
                batch_small_iou_sum, batch_middle_iou_sum, batch_big_iou_sum, batch_small_positive_num, batch_middle_positive_num, batch_big_positive_num = loss_function(small_bounding_boxes, middle_bounding_boxes, big_bounding_boxes,
                                     batch_datas[1],
                                     batch_datas[2],
                                     batch_datas[3],
                                     batch_datas[4],
                ...
                tbar.set_description("train: small_coord_loss:{} small_confidence_loss positive:{} negative:{} small_class_loss:{} small_avg_iou:{} middle_coord_loss:{} middle_confidence_loss positive:{} negative:{} middle_class_loss:{} middle_avg_iou:{} big_coord_loss:{} big_confidence_loss positive:{} negative:{} big_class_loss:{} big_avg_iou:{}".format(
            ...
            print("train-batch-mean loss:{} small_coord_loss:{} small_confidence_loss positive:{} negative:{} small_class_loss:{} small_iou:{} middle_coord_loss:{} middle_confidence_loss positive:{} negative:{} middle_class_loss:{} middle_iou:{} big_coord_loss:{} big_confidence_loss positive:{} negative:{} big_class_loss:{} big_iou{}".format(
