...
train_dataSet = coco_classify(imgs_path="../DataSet/COCO2014/Train/Images", txts_path= "../DataSet/COCO2014/Train/Labels", is_train=True)
val_dataSet = coco_classify(imgs_path="../DataSet/COCO2014/Val/Images", txts_path= "../DataSet/COCO2014/Val/Labels", is_train=False)
#---------------step2:Model-------------------
